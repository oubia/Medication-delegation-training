# Generated by Django 3.1.6 on 2021-05-17 21:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Category_name', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='main_app.categoriesmodel')),
            ],
        ),
        migrations.CreateModel(
            name='Livraison',
            fields=[
                ...
                ('Materiel_id', models.ManyToManyField(to='main_app.MaterielModel')),
            ],
        ),
    ]
